...
**Próxima elegível:** PB-ME-01

**Branch base:** `main`

| Task | Status | Branch | Commit | Modelo/effort efetivo |
|---|---|---|---|---|
| PB-ME-01 | pending | `codex/pbme-01-authoring-contract` | — | — |
| PB-ME-02 | not-ready; depende de 01 | `codex/pbme-02-editor-shell` | — | — |
| PB-ME-03 | not-written | — | — | — |
| PB-ME-04 | not-written | — | — | — |
| PB-ME-05 | not-written | — | — | — |
| PB-ME-06 | not-written | — | — | — |
| PB-ME-07 | not-written | — | — | — |
| PB-ME-08 | not-written | — | — | — |
| PB-ME-09 | not-written | — | — | — |

## Bloqueios

- `main` tem `verify` vermelho por drift de save/spawn já registrado em PB-08. PB-ME não depende do
  fechamento de PB-08, mas PB-ME-01 não começa sobre uma linha de base vermelha.
...
- PB-08-01 já está integrada em `c23c819`; esse layout é a base que PB-ME-01 deve materializar.
