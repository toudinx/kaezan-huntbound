...
const paths = {
  ...
  orcMelee: 'data-otservbr-global/monster/humanoids/orc.lua',
  orcSpearman: 'data-otservbr-global/monster/humanoids/orc_spearman.lua',
...
spell:register()`,
  ...
  [paths.orcMelee]: monster('Orc', 5, 'gold coin'),
  [paths.orcSpearman]: monster('Orc Spearman', 50, 'gold coin'),
