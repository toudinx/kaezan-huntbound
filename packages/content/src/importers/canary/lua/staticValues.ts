...
const symbolicConstants: Readonly<Record<string, string>> = {
  ...
  COMBAT_PARAM_DISTANCEEFFECT: 'COMBAT_PARAM_DISTANCEEFFECT',
  ...
  SOUND_EFFECT_TYPE_SPELL_WOUND_CLEANSING:
    'SOUND_EFFECT_TYPE_SPELL_WOUND_CLEANSING',
  SOUND_EFFECT_TYPE_SPELL_GROUNDSHAKER: 'SOUND_EFFECT_TYPE_SPELL_GROUNDSHAKER',
  SOUND_EFFECT_TYPE_SPELL_OR_RUNE: 'SOUND_EFFECT_TYPE_SPELL_OR_RUNE',
  SOUND_EFFECT_TYPE_SPELL_WHIRLWIND_THROW:
    'SOUND_EFFECT_TYPE_SPELL_WHIRLWIND_THROW',
};
