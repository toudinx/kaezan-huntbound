...
const sourceRoot = `${root}/references/canary`;
...
describe('Canary slice application integration', () => {
  it('materializes the frozen real slice and is idempotent by bundle and row counts', () => {
    ...
    expect(firstBundle.creatures.map((creature) => creature.stableKey)).toEqual(
      [
